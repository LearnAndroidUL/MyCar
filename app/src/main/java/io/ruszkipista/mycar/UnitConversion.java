...
public class UnitConversion {
    ...
    public static final List<UnitConversion> unitConversions = Arrays.asList(
            ...
            new UnitConversion("year", "month", 12),
            new UnitConversion("year", "day", 365.25),
            new UnitConversion("month", "day", 30.4166)
    );
    ...
    public static double fuelEconomy(String fuelUnitOfMeasure, double fuelQuantity,
        ...
        switch (targetUnitOfMeasure) {
            case Unit.Lper100KM:
                ...
                if (lengthQuantityConv != 0.0)
                    targetQuantity = fuelQuantityConv / 100.0 * lengthQuantityConv;
                break;
